view: sales_order_line {
  ...
  measure: total_estimated_cost {
    ...
    type: sum
    drill_fields: [order_id, sales_order.tranid, created_date, SLA_Target_date,sales_order.minimum_ship ,item.product_description, location, sales_order.source, total_units,gross_amt]
    value_format: "$#,##0.00"
    sql: ${TABLE}.estimated_Cost;; }
