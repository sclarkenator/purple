  ...
  derived_table: {
    ...
    with z as (
      ...
      where t.transaction_type in ('Cash Refund', 'Customer Refund')
        ...
        --and to_date(t.create_date) between '2020-10-01' and '2020-11-01'
      UNION
      select
          t.create_date as created,
          regexp_replace(case
      ...
      group by 1,2
        ...
        where transaction_type = 'Tagged Refund'
          ...
          --and to_date(f.time) between '2020-10-01' and '2020-11-01'
        group by 6,7
    ), g as (
      select
      ...
      where f.status = 'Approved'
        ...
        and {% condition date_selector %} f.time {% endcondition %}
          --and f.time between '2020-10-01' and '2020-11-01'
    )
    select * from g
      ;;
  }
