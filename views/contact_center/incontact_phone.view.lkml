view: incontact_phone {
  ...
  ##########################################################################################
  ##########################################################################################
  ## AVERAGE MEASURES old

  measure: abn_time_average_old {
    label: "AVG ABN Time old"
    group_label: "Average Measures old"
    description: "Average time caller spent in queue before abandoning.  Includes long and short abandons."
    type: average
    value_format: "###0.00"
  ...
  measure: acd_time_average_old {
    label: "AVG ACD Time old"
    group_label: "Average Measures old"
    description: "Average time caller spent in ACD."
    type: average
    value_format: "###0.00"
  ...
  measure: acw_time_average_old {
    label: "AVG ACW Time old"
    group_label: "Average Measures old"
    description: "Average time agent spent in ACW."
    type: average
    value_format: "###0.00"
  ...
  measure: active_talk_time_average_old {
    label: "AVG Active Talk Time old"
    group_label: "Average Measures old"
    description: "Average time agent spent actively engaged with caller."
    type: average
    value_format: "###0.00"
  ...
  measure: holds_per_call_average_old {
    label: "AVG Holds old"
    group_label: "Average Measures old"
    description: "Average number of holds per call."
    type: average
  ...
  measure: conference_time_average_old {
    label: "AVG Conference Time old"
    group_label: "Average Measures old"
    description: "Average time agent spent in Conference with another agent and the caller."
    type: average
    value_format: "###0.00"
  ...
  measure: handle_time_average_old {
    label: "AVG Handle Time old"
    group_label: "Average Measures old"
    description: "Average handle time. (ATT+ACW+Conf+Hold)"
    type: average
    value_format: "###0.00"
  ...
  measure: hold_time_average_old {
    label: "AVG Hold Time old"
    group_label: "Average Measures old"
    description: "Average hold time."
    type: average
    value_format: "###0.00"
  ...
  measure: in_queue_time_average_old {
    label: "AVG In Queue Time old"
    group_label: "Average Measures old"
    description: "Average time caller spent in queue."
    type: average
    value_format: "###0.00"
  ...
  measure: long_abn_time_average_old {
    label: "AVG Long ABN Time old"
    group_label: "Average Measures old"
    description: "Average time caller spent in queue before abandoning.  Only counts abandons taking place AFTER designated short abandon time."
    type: average
    value_format: "###0.00"
  ...
  measure: short_abn_time_average_old {
    label: "AVG Short ABN Time old"
    group_label: "Average Measures old"
    description: "Average time caller spent in queue before abandoning.  Only counts abandons taking place BEFORE designated short abandon time."
    type: average
    value_format: "###0.00"
  ...
  measure: speed_of_answer_average_old {
    label: "AVG Speed of Answer Time old"
    group_label: "Average Measures old"
    description: "Time that a Handled Contact spent waiting in the queue after requesting to speak to an agent until the call was routed to the agent.  Does NOT include Abandon calls."
    type: average
    value_format: "###0.00"
  ...
  measure: talk_time_average_old {
    label: "AVG Talk Time old"
    group_label: "Average Measures old"
    description: "Average time caller spent connected with an agent from 'Hello' to 'Goodbye'."
    type: average
    value_format: "###0.00"
  ...
  measure: total_contact_time_average_old {
    label: "AVG Total Contact Time old"
    group_label: "Average Measures old"
    description: "Average total time caller spent on contact. (Prequeue + Inqueue + Active Talk + Hold + Conference + Consult + Postqueue)"
    type: average
    value_format: "###0.00"
