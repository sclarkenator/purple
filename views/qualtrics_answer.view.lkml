view: qualtrics_answer {
  ...
  dimension: answer_order {
    ...
    sql:
      ...
      when ${TABLE}."ANSWER" in ('Less than 6 months ago','Less than 6 months','8-9 hours','$75000 to $99999') then '6'
      when ${TABLE}."ANSWER" in ('Less than 1 year ago','Less than 1 year','10 or more hours','$100000 to $124999') then '7'
      when ${TABLE}."ANSWER" in ('More than 1 year ago','More than 1 year','$125000 to $149999') then '8'
      when ${TABLE}."ANSWER" in ('$150000 to $199999') then '9'
      when ${TABLE}."ANSWER" in ('$200000 to $249999') then '10'
      when ${TABLE}."ANSWER" in ('$250000 or more') then '11'
      else '99'
      end;;
  }
