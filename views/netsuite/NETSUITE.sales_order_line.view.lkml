...
## see data by pop sol (period over period sales order line) is used for the interactive dashboards
  ...
  measure:White_Glove_Qty_eligible_for_SLA{
    ...
    sql: Case
            ...
            Else 0
            END ;;
    filters: [customer_table.companyname: "-Mattress Firm,-Mattress Firm Promos,-Mattress Firm Warehouse", sales_order.channel: "DTC,Owned Retail", carrier: "XPO,Pilot,NEHDS,Ryder,Speedy Delivery,FragilePak,Purple Home Delivery", item.finished_good_flg: "Yes"]
  }
