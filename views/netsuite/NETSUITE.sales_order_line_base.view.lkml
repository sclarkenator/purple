...
#### Used with period comparison view
 ...
 dimension: carrier_raw {
  ...
  dimension: DTC_carrier {
    ...
    hidden: no
    type: string
    sql:  CASE WHEN upper(coalesce(${carrier_raw},'')) not in ('XPO','MANNA','PILOT','MAINFREIGHT','PURPLE HOME DELIVERY','SPEEDY DELIVERY','RYDER','FRAGILEPAK','NEHDS','CRST','SELECT EXPRESS') THEN 'Purple' Else ${carrier} END;;
  }
