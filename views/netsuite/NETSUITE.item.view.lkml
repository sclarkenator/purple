  ...
  dimension: ecommerce_categories {
    ...
    sql:
      case
        ...
        when ${sku_clean} in ('10-38-13025','10-38-13030','10-38-13020') then 'Duvet - All Season'
        when ${sku_clean} in ('10-38-13010','10-38-13015','10-38-13005') then 'Duvet - Light'
        when ${sku_clean} in ('10-38-13959','10-38-13794','10-38-13810','10-38-13787','10-38-13956','10-38-13824',
        '10-38-12554') then 'Pillow Case'
        when ${sku_clean} = '10-31-12863' then 'Pillow Booster'
        when ${sku_clean} in ('10-31-12890','10-31-12895') then 'Harmony Pillow'
        when ${sku_clean} in ('10-31-12854','10-31-12857') then 'Original Pillow'
        when ${sku_clean} = '10-31-12860' then 'Plush Pillow'
        when ${sku_clean} = '10-31-12855' then 'Purple Pillow'
        when ${sku_clean} in ('10-38-22823','10-38-13960','10-38-13818','10-38-13795','10-38-13811','10-38-13788',
        '10-38-13957','10-38-13781','10-38-13825','10-38-13832','10-38-13849','10-38-13764','10-38-13780','10-38-13809',
        '10-38-13786','10-38-13816','10-38-13779','10-38-13847','10-38-12850','10-38-12793','10-38-12809','10-38-12786',
        '10-38-12849','10-38-12823','10-38-12816','10-38-12779','10-38-12790','10-38-12789','10-38-12787','10-38-12788',
        '10-38-12848','10-38-12830','10-38-12847','10-38-12762') then 'Purple Sheets'
        when ${sku_clean} in ('10-38-12717','10-38-12748','10-38-12755','10-38-12694','10-38-12700','10-38-12731',
        '10-38-12724') then 'Purple Mattress Protector'
        when ${sku_clean} = '10-38-13919' then 'Mattress Protector'

        --Cushions--
        when ${sku_clean} in ('10-41-12585','10-41-12378','10-41-12582','10-41-12540','10-41-12574','10-41-12583','10-41-12572','10-41-12496',
        '10-41-12573','10-41-12533','10-41-12584','10-41-12576','10-41-12519','10-41-12564') then 'Cushion'
        ...
        '10-38-12876','10-38-12875','10-38-12878','10-31-12856') then 'Replacement Parts'
        when ${sku_clean} = '10-11-18300' then 'Misc'
        when ${sku_clean} = '10-31-12910' then 'Harmony Core'
        when ${sku_clean} in ('10-25-18265','10-50-18265','10-11-18264') then 'Purple Squishies'
       ...
       --Bases--
        when ${sku_clean} in ('10-38-45867','10-38-45864','10-38-45872','10-38-45866','10-38-45871','10-38-45865',
        '10-38-45873','10-38-45870') then 'The Purple Foundation'
        ...
        '10-38-92892','10-38-82890','10-38-12822','10-38-12893','10-38-12815','10-38-12846','10-38-12892') then 'The Purple Platform'
        when ${sku_clean} = '10-21-13027' then 'Powerbase'
        when ${sku_clean} in ('10-38-12946','10-38-12939','10-38-12948','10-38-12955','10-38-12952') then 'Purple Powerbase'
