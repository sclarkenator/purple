view: assembly_build {
  ...
  dimension: current_week_num{
    ...
    type: yesno
<<<<<<< HEAD
    sql: ${TABLE}.PRODUCED::date <= '2019-12-30' ;;}
...
>>>>>>> branch 'master' of git@github.com:sclarkenator/purple.git
  ...
  dimension: prev_week{
    ...
    type: yesno
<<<<<<< HEAD
    sql:  ${TABLE}.PRODUCED::date >= '2019-12-23' and ${TABLE}.PRODUCED::date <= '2019-12-29' ;; }
...
<<<<<<< HEAD
    sql: case
    when ${TABLE}.PRODUCED::date >= '2019-12-30' and ${TABLE}.PRODUCED::date <= '2020-01-05' then 'Current Week'
    when ${TABLE}.PRODUCED::date >= '2019-12-23' and ${TABLE}.PRODUCED::date <= '2019-12-29' then 'Last Week'
    when ${TABLE}.PRODUCED::date >= '2019-12-16' and ${TABLE}.PRODUCED::date <= '2019-12-22' then 'Two Weeks Ago'
    when ${TABLE}.PRODUCED::date >= '2018-12-31' and ${TABLE}.PRODUCED::date <= '2019-01-06' then 'Current Week LY'
    when ${TABLE}.PRODUCED::date >= '2018-12-24' and ${TABLE}.PRODUCED::date <= '2018-12-30' then 'Last Week LY'
    when ${TABLE}.PRODUCED::date >= '2018-12-17' and ${TABLE}.PRODUCED::date <= '2018-12-23' then 'Two Weeks Ago LY'
    else 'Other' end ;; }
