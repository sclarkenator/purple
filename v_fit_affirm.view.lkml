view: v_fit_affirm {
  sql_table_name: ACCOUNTING.V_FIT_AFFIRM ;;

  dimension: a_currencyvarchar {
    type: string
    sql: ${TABLE}."A.CURRENCY::VARCHAR" ;;
  }
  ...
  dimension: netetsuite_transaction_id {
    type: string
    sql: ${TABLE}."NETETSUITE_TRANSACTION_ID" ;;
  }
